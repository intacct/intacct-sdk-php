 ...
 */
class AttachmentsFolderCreate extends AbstractAttachmentsFolder
{
    ...
    public function writeXml(XMLWriter &$xml)
    {
        ...
        $xml->startElement('create_supdocfolder');

        if (!$this->getFolderName()) {
            throw new InvalidArgumentException('Attachments Folder Name is required for create');
        }
        ...
        $xml->endElement(); //create_supdocfolder
