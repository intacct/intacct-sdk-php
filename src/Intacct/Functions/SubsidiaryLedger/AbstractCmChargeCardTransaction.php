...
abstract class AbstractCmChargeCardTransaction extends AbstractFunction
{
    ...
    /** @var AbstractCmChargeCardTransactionLine[] */
    protected $lines;
    ...
    /**
     * @return AbstractCmChargeCardTransactionLine[]
     */
    ...
    /**
     * @param AbstractCmChargeCardTransactionLine[] $lines
     */
