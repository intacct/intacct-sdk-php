 ...
 */
class ExpenseAdjustmentDelete extends AbstractExpenseAdjustment
{
    ...
    public function writeXml(XMLWriter &$xml)
    {
        ...
        $xml->startElement('delete_expenseadjustmentreport');
        ...
        $xml->endElement(); //delete_expenseadjustmentreport
