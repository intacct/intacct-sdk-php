...
class CreateArInvoiceEntry extends AbstractTransactionEntry
{
    ...
    public function __construct(array $params = [])
    {
        $defaults = [
            ...
            'contract_id' => null,
            'warehouse_id' => null,
            'rev_rec_template_id' => null,
            'deferred_rev_gl_account_no' => null,
        ...
        $this->setRevRecTemplateId($config['rev_rec_template_id']);
        $this->setDeferredRevGlAccountNo($config['deferred_rev_gl_account_no']);
    ...
    public function writeXml(XMLWriter &$xml)
    {
        ...
        $xml->writeElement('revrecstartdate', $this->getRevRecStartDate());
        $xml->writeElement('revrecenddate', $this->getRevRecEndDate());
