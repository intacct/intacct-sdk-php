...
class PaymentReverseTest extends \PHPUnit_Framework_TestCase
{

    /**
     * @covers Intacct\Functions\AccountsReceivable\PaymentReverse::writeXml
     */
...
EOF;
        ...
        $record = new PaymentReverse('unittest');
