...
class CustomerAdjustmentLineCreateTest extends \PHPUnit_Framework_TestCase
{

    /**
     * @covers Intacct\Functions\AccountsReceivable\CustomerAdjustmentLineCreate::writeXml
     */
...
EOF;
        ...
        $line = new CustomerAdjustmentLineCreate();
