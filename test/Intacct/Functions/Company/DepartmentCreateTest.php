...
class DepartmentCreateTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @covers Intacct\Functions\Company\DepartmentCreate::writeXml
     */
...
EOF;
        ...
        $department = new DepartmentCreate('unittest');
     ...
     * @expectedExceptionMessage Department ID is required for create
     */
     ...
     * @covers Intacct\Functions\Company\DepartmentCreate::writeXml
     * @expectedException InvalidArgumentException
     * @expectedExceptionMessage Department Name is required for create
     */
