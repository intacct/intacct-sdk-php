...
class PaymentRequestCreateTest extends \PHPUnit_Framework_TestCase
{

    /**
     * @covers Intacct\Functions\AccountsPayable\PaymentRequestCreate::writeXml
     */
...
EOF;
        ...
        $payment = new PaymentRequestCreate('unittest');
