...
class VendorAdjustmentLineCreateTest extends \PHPUnit_Framework_TestCase
{

    /**
     * @covers Intacct\Functions\AccountsPayable\VendorAdjustmentLineCreate::writeXml
     */
...
EOF;
        ...
        $line = new VendorAdjustmentLineCreate();
