...
class VendorAdjustmentCreateTest extends \PHPUnit_Framework_TestCase
{

    /**
     * @covers Intacct\Functions\AccountsPayable\VendorAdjustmentCreate::writeXml
     */
...
EOF;
        ...
        $apAdjustment = new VendorAdjustmentCreate('unittest');
