 ...
 */
class InventoryTransactionDeleteTest extends \PHPUnit\Framework\TestCase
{
...
EOF;
        ...
        $classObj = new InventoryTransactionDelete('unittest');
    ...
    public function testRequiredId(): void
    {
        ...
        $obj = new InventoryTransactionDelete('unittest');
