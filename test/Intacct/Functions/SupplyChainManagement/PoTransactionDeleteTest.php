...
class PoTransactionDeleteTest extends \PHPUnit_Framework_TestCase
{

    /**
     * @covers Intacct\Functions\SupplyChainManagement\PoTransactionDelete::writeXml
     */
...
EOF;
        ...
        $classObj = new PoTransactionDelete('unittest');
    ...
    public function testRequiredId()
    {
        ...
        $obj = new PoTransactionDelete('unittest');
