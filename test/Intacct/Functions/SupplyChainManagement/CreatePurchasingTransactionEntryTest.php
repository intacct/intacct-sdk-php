...
class CreatePurchasingTransactionEntryTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @covers Intacct\Functions\SupplyChainManagement\CreatePurchasingTransactionEntry::__construct
     * @covers Intacct\Functions\SupplyChainManagement\CreatePurchasingTransactionEntry::writeXml
     */
...
EOF;
        ...
        $purchasingTransactionEntry->writeXml($xml);
