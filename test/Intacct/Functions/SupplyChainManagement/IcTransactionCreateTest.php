...
class IcTransactionCreateTest extends \PHPUnit_Framework_TestCase
{

    /**
     * @covers Intacct\Functions\SupplyChainManagement\IcTransactionCreate::writeXml
     */
