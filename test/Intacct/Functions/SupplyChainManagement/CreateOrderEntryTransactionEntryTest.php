...
class CreateOrderEntryTransactionEntryTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @covers Intacct\Functions\SupplyChainManagement\CreateOrderEntryTransactionEntry::__construct
     * @covers Intacct\Functions\SupplyChainManagement\CreateOrderEntryTransactionEntry::writeXml
     * @covers Intacct\Functions\SupplyChainManagement\CreateOrderEntryTransactionEntry::writeXmlItemDetails
     */
...
EOF;
        ...
        $orderEntryTransactionEntry->writeXml($xml);
...
EOF;
        ...
        $orderEntryTransactionEntry = new CreateOrderEntryTransactionEntry([
            ...
            'rev_rec_start_date' => new Date('2015-06-30'),
            'rev_rec_end_date' => new Date('2015-07-31'),
