...
class OeTransactionLineCreateTest extends \PHPUnit_Framework_TestCase
{

    /**
     * @covers Intacct\Functions\SupplyChainManagement\OeTransactionLineCreate::writeXml
     */
...
EOF;
        ...
        $entry = new OeTransactionLineCreate();
