...
class OeTransactionDeleteTest extends \PHPUnit_Framework_TestCase
{

    /**
     * @covers Intacct\Functions\SupplyChainManagement\OeTransactionDelete::writeXml
     */
...
EOF;
    ...
    public function testRequiredId()
    {
        ...
        $obj = new OeTransactionDelete('unittest');
