...
class IcTransactionLineCreateTest extends \PHPUnit_Framework_TestCase
{

    /**
     * @covers Intacct\Functions\SupplyChainManagement\IcTransactionLineCreate::writeXml
     */
...
EOF;
        ...
        $entry = new IcTransactionLineCreate();
