...
class PoTransactionLineCreateTest extends \PHPUnit_Framework_TestCase
{

    /**
     * @covers Intacct\Functions\SupplyChainManagement\PoTransactionLineCreate::writeXml
     */
...
EOF;
        ...
        $entry = new PoTransactionLineCreate();
