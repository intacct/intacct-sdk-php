...
class ArInvoiceDeleteTest extends \PHPUnit_Framework_TestCase
{

    /**
     * @covers Intacct\Functions\SubsidiaryLedger\ArInvoiceDelete::writeXml
     */
...
EOF;
        ...
        $classObj = new ArInvoiceDelete('unittest');
    ...
    public function testRequiredId()
    {
        ...
        $obj = new ArInvoiceDelete('unittest');
