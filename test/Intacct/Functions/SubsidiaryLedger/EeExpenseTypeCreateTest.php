...
class EeExpenseTypeCreateTest extends \PHPUnit_Framework_TestCase
{

    /**
     * @covers Intacct\Functions\SubsidiaryLedger\EeExpenseTypeCreate::writeXml
     */
...
EOF;
        ...
        $label = new EeExpenseTypeCreate('unittest');
