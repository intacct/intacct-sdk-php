...
class CreatePurchasingTransactionTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @covers Intacct\Functions\Purchasing\CreatePurchasingTransaction::__construct
     * @covers Intacct\Functions\Purchasing\CreatePurchasingTransaction::getXml
     * @covers Intacct\Functions\Purchasing\CreatePurchasingTransaction::getExchangeRateInfoXml
     * @covers Intacct\Functions\Purchasing\CreatePurchasingTransaction::getPurchasingTransactionEntries
     */
...
EOF;
        ...
        $purchasingTransaction->getXml($xml);
     ...
     * @covers Intacct\Functions\Purchasing\CreatePurchasingTransaction::getExchangeRateInfoXml
     * @covers Intacct\Functions\Purchasing\CreatePurchasingTransaction::getPurchasingTransactionEntries
     * @covers Intacct\Functions\Purchasing\CreatePurchasingTransaction::getSubtotalEntries
     */
...
EOF;
     ...
     * @covers Intacct\Functions\Purchasing\CreatePurchasingTransaction::getPurchasingTransactionEntries
     * @expectedException InvalidArgumentException
     * @expectedExceptionMessage "purchasing_transaction_entries" param must have at least 1 entry
     */
